...
public class AutoUploadService extends Service
{
	...
	public void onCreate() {
		...
		receiver = new AutoUploadEventsReceiver();
	...
	private class AutoUploadEventsReceiver extends EventsReceiver {
		public AutoUploadEventsReceiver() {
			...
			AutoUploadService.this.isConnected = isConnected;
			AutoUploadService.this.isWifi = isWifi;
			AutoUploadService.this.isRoaming = isRoaming;
			AutoUploadService.this.isCharging = isCharging;
			updateCanAutoUploadAsync();
		}
